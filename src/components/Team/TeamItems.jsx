...
function TeamItems() {
  ...
  const [currentDoctorName, setCurrentDoctorName] = useState(doctorNames[0]);

  const handleSwiper = swiper => {
    swiper.on('slideChange', () => {
      const activeIndex = swiper.realIndex;
      setCurrentDoctorName(doctorNames[activeIndex]);
    });
  };
  ...
  return (
    <div className='container'>
      ...
      <Swiper
        ...
        onSwiper={handleSwiper} // Call this function when Swiper is initialized
        navigation={{
      ...
      >
        ...
        <div className='doctor-name-container'>{currentDoctorName}</div>
      </Swiper>
    </div>
  );
}
