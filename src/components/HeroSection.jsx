...
const HeroSection = () => {
  return (
    <section
      name='home'
      className='relative w-full bg-cover bg-left md:bg-center bg-no-repeat bg-center md:bg-left bg-fixed bg-gray-800 md:py-20'
      id='hero'
    >
      <video
        autoPlay
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center min-h-screen'>
        <div className='md:w-1/2 text-center md:text-left relative z-10 mx-auto md:mx-0'>
          <h2 className='font-semibold text-2xl sm:text-3xl md:text-5xl leading-tight md:leading-10 text-white uppercase drop-shadow-lg'>
            Let us brighten your smile
          </h2>
          <p className='py-5 leading-7 text-white drop-shadow-lg'>
            Creating healthier smiles through expert care and precision.
          </p>
          <Button text='Make Appointment' className='relative z-10' />
        </div>
      </div>
    </section>
  );
